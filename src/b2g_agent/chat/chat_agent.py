...
from b2g_agent.cases.building_to_grid.workflow import run_building_to_grid
...
from b2g_agent.chat.llm_intent_parser import LLMIntentValidationError, LLMIntentParser
from b2g_agent.chat.result_summarizer import ResultSummarizer
...
class ChatAgent:
    ...
    def handle(self, text: str) -> tuple[str, bool]:
        try:
            ...
            return "I could not turn that into a valid B2G-Agent action. Please rephrase.", False
