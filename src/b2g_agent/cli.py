...
from b2g_agent.cases.building_to_grid.workflow import run_building_to_grid as run_case


def run_building_to_grid(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run the B2G Building-to-Grid workflow.")
    parser.add_argument(
        "--config",
